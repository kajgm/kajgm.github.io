    ...
    <div className="content-container twty-margin-bottom">
      ...
      <ul>
        <p className="bullet-text two-fade-in no-margin">
          <li>Assigned to the core infrastructure team involved with development, maintenance, and on-call support</li>
          <li>Participated in daily stand-ups and scrum meetings to continuously improve development process</li>
          <li>
            Responded to concurrent <strong>Jira</strong> tickets involving new features or fixes to existing systems
          </li>
          <li>
