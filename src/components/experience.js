...
const Experience = () => {
  return (
    <div id="experience-container" className="content homepage">
      ...
      <div className="experience sub-content">
        <div className="content-container twty-margin-bottom">
          <div className="exp-headers-container">
            <a href="https://www.sap.com/canada/index.html">
              <img src={data[0].image} id="SAP-logo" className="company-logos relative" alt="SAP" />
            </a>
          ...
          <ul>
            <p className="bullet-text two-fade-in no-margin">
              <li>
                Assigned to the core infrastructure team involved with development, maintenance, and on-call support
              </li>
              <li>Participated in daily stand-ups and scrum meetings to continuously improve development process</li>
              <li>
                Responded to concurrent <strong>Jira</strong> tickets involving new features or fixes to existing
                systems
              </li>
              <li>
                Tested proposed changes in <strong>Jenkins</strong> voter system, local <strong>Docker</strong> and{' '}
                <strong>Kubernetes</strong> cloud environments
              </li>
            </p>
          </ul>
        </div>
        <div className="content-container">
          ...
          <ul>
            <p className="bullet-text two-fade-in no-margin">
              <li>
                Created several apps in <strong>C</strong>, <strong>Python</strong>, and <strong>JavaScript</strong> to
                assist with production and senior engineer workflows
              </li>
              <li>
                Given administrative level access to troubleshoot a variety of issues on production level{' '}
                <strong>Linux</strong> machines
              </li>
              <li>
                Deployed several projects to assist with the transition of 800+ employees to a work-from-home workflow
              </li>
              <li>
