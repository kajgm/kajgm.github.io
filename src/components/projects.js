...
const Projects = () => {
  return (
    <div id="projects-container" className="content homepage">
        ...
        <div className="content-container twty-margin-bottom">
          ...
          <ul>
            <p className="bullet-text two-fade-in no-margin">
              <li>
                Involves multithreaded operation to detect note frequency and output live feedback to a VGA based ui
              </li>
              <li>
        ...
        <div className="content-container twty-margin-bottom">
          ...
          <ul>
            <p className="bullet-text two-fade-in no-margin">
              ...
              <li>
                Large <b>7000mAh</b> capacity battery and the ability to move a <b>125kg</b> load at a <b>2.5m/s</b>{' '}
                pace
              </li>
            </p>
          </ul>
        ...
        <div className="content-container twty-margin-bottom">
          ...
          <ul>
            <p className="bullet-text two-fade-in no-margin">
              <li>
                {' '}
                Optimized the common Gaussian Elimination Algorithm using buffering, tiling, memory, compute, and
                ping-pong data transfer enhancements
              </li>
              <li>
                {' '}
